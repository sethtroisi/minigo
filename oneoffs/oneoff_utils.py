    ...
    if os.path.exists(save_file):
        try:
            ...
            if test == params:
                ...
                print ("Params didn't match {} != {}".format(test, params))
        except Exception as e:
            print ("Failed to load save_file:", e)
    return False, None


def save_checkpoint(save_file, params, data):
    with open(save_file, "wb") as pickle_file:
        pickle.dump((params, data), pickle_file)
